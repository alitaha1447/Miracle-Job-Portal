...
const columnFields: ColumnField[] = [
    ...
    { value: 8, label: 'Last Submission Date	' },
    { value: 9, label: 'Total Applicant	' },
...
const JobDashboard: React.FC = () => {
        ...
        useMemo(() => (
            {
                ...
                8: { header: "Last Submission Date	", render: (r: any) => r.date },
                9: {
    ...
    }, [selectedValues, columnMap, openMenuIdx]);
    ...
    const toggleRowMenu = (idx: number) => {
        // console.log('Dropdown clicked', idx); // Log to see when it's clicked
        setOpenMenuIdx(prev => (prev === idx ? null : idx)); // Toggle the dropdown visibility
    };
                    ...
                    >
                        ...
                        <div className=" p-4 border-t border-gray-100 dark:border-gray-800 sm:p-6">
                            <div className="space-y-6">
                                ...
                                <div className="hidden lg:block relative overflow-visible rounded-xl border border-gray-200 bg-white dark:border-white/[0.05] dark:bg-white/[0.03]">
                                ...
                                {/* Mobile Card View */}
                                <div className="lg:hidden overflow-hidden grid grid-cols-1 md:grid-cols-2 gap-4">
